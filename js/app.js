// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["dyttzy","ruyi","bfzy","tyyszy","ffzy","heimuer","zy360","iqiyi","wolong","hwba", "jisu","dbzy","mozhua","mdzy","zuid","yinghua","baidu","wujin","wwzy","ikun"]'); // 默认选中资源
